...
import ProfileController from '../../../controllers/company/auth/ProfileController'
import Joi from 'joi'
...
export default [
  {
    path: '/api/company/auth/profile/profile',
    method: 'GET',
  ...
  {
    path: '/api/company/auth/profile/change-password',
    method: 'POST',
  ...
  {
    path: '/api/company/auth/profile/change-profile',
    method: 'POST',
